...
`shakilabs-ui-0.3.33.tgz` is the active exact artifact for `@shakilabs/ui` 0.3.33.

- Source repository: `kosmosbrewing/00.root-shakilabs`
- Source commit: `29bd4b06884a55baf4816e91dfa86fc5310b4c7b`
- SHA-256: `ef623801ec1baaeaba5ac8a28dc1b07b1036c495ea5242f5bdca5e2ada64ad09`
- Consumed by: `client/package.json` → `"@shakilabs/ui": "file:vendor/shakilabs-ui-0.3.33.tgz"`
...
```sh
shasum -a 256 client/vendor/shakilabs-ui-0.3.33.tgz   # 위 SHA-256과 일치해야 한다
