...
const sitemapRoutes = [
  { path: "/crypto-tax", changefreq: "daily", priority: "1.0" },
  { path: "/dividend-tax", changefreq: "weekly", priority: "0.9" },
  { path: "/isa", changefreq: "weekly", priority: "0.9" },
];
...
function renderSitemap(buildDate) {
  const baseUrl = "https://invest.shakilabs.com";
