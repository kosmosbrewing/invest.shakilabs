...
<template>
  <AccordionHeader class="flex">
    <AccordionTrigger
      ...
      :class="cn('flex flex-1 items-center justify-between gap-4 py-3 text-left font-semibold transition-colors hover:text-primary [&[data-state=open]>svg]:rotate-45', props.class)"
    >
      <slot />
